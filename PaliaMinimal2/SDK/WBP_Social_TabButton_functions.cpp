...
#include "WBP_Social_TabButton_classes.hpp"
#include "WBP_Social_TabButton_parameters.hpp"
...
void UWBP_Social_TabButton_C::OnMouseEnter(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_TabButton_C", "OnMouseEnter");

	Params::WBP_Social_TabButton_C_OnMouseEnter Parms{};
...
void UWBP_Social_TabButton_C::OnMouseLeave(struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_TabButton_C", "OnMouseLeave");

	Params::WBP_Social_TabButton_C_OnMouseLeave Parms{};
...
void UWBP_Social_TabButton_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_TabButton_C", "PreConstruct");

	Params::WBP_Social_TabButton_C_PreConstruct Parms{};
...
void UWBP_Social_TabButton_C::UpdateBadgeCount(int32 Count)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_TabButton_C", "UpdateBadgeCount");

	Params::WBP_Social_TabButton_C_UpdateBadgeCount Parms{};
...
void UWBP_Social_TabButton_C::UpdateHoverStatePermission(bool Allowed, bool ResetTab, bool CallFunc_Not_PreBool_ReturnValue, const struct FLinearColor& CallFunc_Conv_ColorToLinearColor_ReturnValue, const struct FLinearColor& CallFunc_Conv_ColorToLinearColor_ReturnValue_1, bool CallFunc_IsHovered_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Social_TabButton_C", "UpdateHoverStatePermission");

	Params::WBP_Social_TabButton_C_UpdateHoverStatePermission Parms{};
