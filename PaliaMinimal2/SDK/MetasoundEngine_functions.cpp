...
void UMetasoundGeneratorHandle::OnOutputValueChangedMulticast__DelegateSignature(class FName Param_Name, struct FMetaSoundOutput& Output)
{
	static class UFunction* Func = nullptr;
...
struct FMetaSoundNodeHandle UMetaSoundBuilderBase::AddNodeByClassName(struct FMetasoundFrontendClassName& ClassName, int32 MajorVersion, EMetaSoundBuilderResult* OutResult)
{
	static class UFunction* Func = nullptr;
