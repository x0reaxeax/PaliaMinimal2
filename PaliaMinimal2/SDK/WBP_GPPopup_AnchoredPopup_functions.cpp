...
#include "WBP_GPPopup_AnchoredPopup_classes.hpp"
#include "WBP_GPPopup_AnchoredPopup_parameters.hpp"
...
bool UWBP_GPPopup_AnchoredPopup_C::BP_OnHandleBackAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GPPopup_AnchoredPopup_C", "BP_OnHandleBackAction");

	Params::WBP_GPPopup_AnchoredPopup_C_BP_OnHandleBackAction Parms{};
...
// Function WBP_GPPopup_AnchoredPopup.WBP_GPPopup_AnchoredPopup_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UWBP_GPPopup_AnchoredPopup_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GPPopup_AnchoredPopup_C", "Construct");
...
// Function WBP_GPPopup_AnchoredPopup.WBP_GPPopup_AnchoredPopup_C.OnDismissTimerComplete
// (BlueprintCallable, BlueprintEvent)

void UWBP_GPPopup_AnchoredPopup_C::OnDismissTimerComplete()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GPPopup_AnchoredPopup_C", "OnDismissTimerComplete");
...
void UWBP_GPPopup_AnchoredPopup_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GPPopup_AnchoredPopup_C", "Tick");

	Params::WBP_GPPopup_AnchoredPopup_C_Tick Parms{};
