...
void UStructUtilsFunctionLibrary::GetInstancedStructValue(EStructUtilsResult* ExecResult, struct FInstancedStruct& InstancedStruct, int32* Value)
{
	static class UFunction* Func = nullptr;
...
EStructUtilsResult UStructUtilsFunctionLibrary::IsInstancedStructValid(struct FInstancedStruct& InstancedStruct)
{
	static class UFunction* Func = nullptr;
