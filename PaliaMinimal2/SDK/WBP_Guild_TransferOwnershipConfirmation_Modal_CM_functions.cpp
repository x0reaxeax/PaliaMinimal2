...
#include "WBP_Guild_TransferOwnershipConfirmation_Modal_CM_classes.hpp"
#include "WBP_Guild_TransferOwnershipConfirmation_Modal_CM_parameters.hpp"


namespace SDK
{

// Function WBP_Guild_TransferOwnershipConfirmation_Modal_CM.WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C.BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_2_Cancel__DelegateSignature
// (BlueprintEvent)

void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_2_Cancel__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_2_Cancel__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_Guild_TransferOwnershipConfirmation_Modal_CM.WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C.BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_3_Confirm__DelegateSignature
// (BlueprintEvent)

void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_3_Confirm__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "BndEvt__WBP_Guild_TransferOwnershipConfirmation_Modal_CM_WBP_Template_PopupSecondary_02_CM_K2Node_ComponentBoundEvent_3_Confirm__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_Guild_TransferOwnershipConfirmation_Modal_CM.WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "Construct");
...
void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::HandleTransferFailure(const class FString& ErrorMessage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "HandleTransferFailure");

	Params::WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C_HandleTransferFailure Parms{};
...
// Function WBP_Guild_TransferOwnershipConfirmation_Modal_CM.WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C.HandleTransferSuccess
// (Private, BlueprintCallable, BlueprintEvent)

void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::HandleTransferSuccess()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "HandleTransferSuccess");
...
void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::OnFailure_CA4DF942458EB985F2A7B2B5D03939C9(struct FGuid& AccountId)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "OnFailure_CA4DF942458EB985F2A7B2B5D03939C9");

	Params::WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C_OnFailure_CA4DF942458EB985F2A7B2B5D03939C9 Parms{};
...
void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::OnSuccess_CA4DF942458EB985F2A7B2B5D03939C9(struct FGuid& AccountId, TArray<struct FOSSVAL_CharacterNameAndId>& Names)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "OnSuccess_CA4DF942458EB985F2A7B2B5D03939C9");

	Params::WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C_OnSuccess_CA4DF942458EB985F2A7B2B5D03939C9 Parms{};
...
void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "PreConstruct");

	Params::WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C_PreConstruct Parms{};
...
void UWBP_Guild_TransferOwnershipConfirmation_Modal_CM_C::TransferOwnership(class UVAL_PlayerGuildSubsystem* CallFunc_GetLocalPlayerSubsystem_ReturnValue, class UVAL_PlayerGuildSubsystem* CallFunc_GetLocalPlayerSubsystem_ReturnValue_1, class UAuthManager* CallFunc_GetLocalPlayerSubsystem_ReturnValue_2, const struct FUniqueNetIdRepl& CallFunc_GetNetId_ReturnValue, TDelegate<void(const class FString& ErrorMessage)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_TryGetUserMembership_bOutHasMembership, const struct FVAL_PlayerGuild& CallFunc_TryGetUserMembership_PlayerGuild, bool CallFunc_TryGetUserMembership_ReturnValue, TDelegate<void()> K2Node_CreateDelegate_OutputDelegate_1, const struct FVAL_PlayerGuild& K2Node_SetFieldsInStruct_StructOut, class UVAL_PlayerGuildSubsystem* CallFunc_GetLocalPlayerSubsystem_ReturnValue_3, bool CallFunc_CanTransferGuildOwnership_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C", "TransferOwnership");

	Params::WBP_Guild_TransferOwnershipConfirmation_Modal_CM_C_TransferOwnership Parms{};
