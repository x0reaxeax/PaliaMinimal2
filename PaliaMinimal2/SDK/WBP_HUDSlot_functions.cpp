...
#include "WBP_HUDSlot_classes.hpp"
#include "WBP_HUDSlot_parameters.hpp"


namespace SDK
{

// Function WBP_HUDSlot.WBP_HUDSlot_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UWBP_HUDSlot_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUDSlot_C", "Construct");
...
void UWBP_HUDSlot_C::HandleEquipmentChanged(class UEquipmentComponent* EquipmentComponent, const struct FEquipmentItem& Item)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUDSlot_C", "HandleEquipmentChanged");

	Params::WBP_HUDSlot_C_HandleEquipmentChanged Parms{};
...
void UWBP_HUDSlot_C::HandleEquippedItemUpdate(class UObject* CallFunc_LoadAsset_Blocking_ReturnValue, bool CallFunc_SetTool_IsVisible, class UVAL_ItemTypeDefinitionAsset* K2Node_DynamicCast_AsItem_Type_Definition, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUDSlot_C", "HandleEquippedItemUpdate");

	Params::WBP_HUDSlot_C_HandleEquippedItemUpdate Parms{};
...
void UWBP_HUDSlot_C::HandleOnChanged(class UInventoryComponent* Inventory)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_HUDSlot_C", "HandleOnChanged");

	Params::WBP_HUDSlot_C_HandleOnChanged Parms{};
