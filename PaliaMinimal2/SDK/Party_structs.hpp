...
public:
	...
	uint8                                         Pad_3333[0x7];                                     // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3334[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3335[0x10];                                    // 0x0018(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberPlatformData               PlatformData;                                      // 0x0028(0x0098)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_3336[0x90];                                    // 0x00C0(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3337[0x37];                                    // 0x0151(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 JoinMethod;                                        // 0x0188(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3338[0x30];                                    // 0x0198(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberJoinInProgressData         JoinInProgressData;                                // 0x01C8(0x0048)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_3339[0x60];                                    // 0x0210(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_333A[0x9];                                     // 0x0018(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0021(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_333B[0x34];                                    // 0x0024(0x0034)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_333C[0x18];                                    // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_333D[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USocialChatChannel*>             ListenChannels;                                    // 0x0018(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_333E[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
