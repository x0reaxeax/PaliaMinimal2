...
#include "BP_NameValidator_MaxCharacters_Apostrophe_classes.hpp"
#include "BP_NameValidator_MaxCharacters_Apostrophe_parameters.hpp"
...
bool UBP_NameValidator_MaxCharacters_Apostrophe_C::IsNameValid(const class FString& InCharacterName, const class FString& CallFunc_Concat_StrStr_ReturnValue, bool CallFunc_IsNameValid_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue, const class FString& CallFunc_Conv_IntToString_ReturnValue, int64 CallFunc_Conv_IntToInt64_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_2, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const class FString& CallFunc_Concat_StrStr_ReturnValue_3, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NameValidator_MaxCharacters_Apostrophe_C", "IsNameValid");

	Params::BP_NameValidator_MaxCharacters_Apostrophe_C_IsNameValid Parms{};
