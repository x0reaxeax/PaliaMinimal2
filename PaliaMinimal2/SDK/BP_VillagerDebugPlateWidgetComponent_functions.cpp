...
#include "BP_VillagerDebugPlateWidgetComponent_classes.hpp"
#include "BP_VillagerDebugPlateWidgetComponent_parameters.hpp"
...
// class UWBP_VillagerDebugPlate_C*        K2Node_DynamicCast_AsWBP_Villager_Debug_Plate          (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UBP_VillagerDebugPlateWidgetComponent_C::ExecuteUbergraph_BP_VillagerDebugPlateWidgetComponent(int32 EntryPoint, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class UWBP_VillagerDebugPlate_C* K2Node_DynamicCast_AsWBP_Villager_Debug_Plate, bool K2Node_DynamicCast_bSuccess, class AActor* CallFunc_GetOwner_ReturnValue, class AValeriaVillagerCharacter* K2Node_DynamicCast_AsValeria_Villager_Character, bool K2Node_DynamicCast_bSuccess_1)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VillagerDebugPlateWidgetComponent_C", "ExecuteUbergraph_BP_VillagerDebugPlateWidgetComponent");

	Params::BP_VillagerDebugPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerDebugPlateWidgetComponent Parms{};

	Parms.EntryPoint = EntryPoint;
	Parms.CallFunc_GetUserWidgetObject_ReturnValue = CallFunc_GetUserWidgetObject_ReturnValue;
	Parms.K2Node_DynamicCast_AsWBP_Villager_Debug_Plate = K2Node_DynamicCast_AsWBP_Villager_Debug_Plate;
...
// Function BP_VillagerDebugPlateWidgetComponent.BP_VillagerDebugPlateWidgetComponent_C.On Widget Created
// (BlueprintCallable, BlueprintEvent)

void UBP_VillagerDebugPlateWidgetComponent_C::On_Widget_Created()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VillagerDebugPlateWidgetComponent_C", "On Widget Created");
