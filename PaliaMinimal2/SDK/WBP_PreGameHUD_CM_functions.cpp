...
#include "WBP_PreGameHUD_CM_classes.hpp"
#include "WBP_PreGameHUD_CM_parameters.hpp"


namespace SDK
{

// Function WBP_PreGameHUD_CM.WBP_PreGameHUD_CM_C.DisplayCharacterCreationMatchmaking
// (Event, Public, BlueprintCallable, BlueprintEvent)

void UWBP_PreGameHUD_CM_C::DisplayCharacterCreationMatchmaking()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "DisplayCharacterCreationMatchmaking");
...
void UWBP_PreGameHUD_CM_C::DisplayMatchmakingQueueActive(bool bActive)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "DisplayMatchmakingQueueActive");

	Params::WBP_PreGameHUD_CM_C_DisplayMatchmakingQueueActive Parms{};
...
void UWBP_PreGameHUD_CM_C::DisplayMatchmakingQueueNumber(int32 Number)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "DisplayMatchmakingQueueNumber");

	Params::WBP_PreGameHUD_CM_C_DisplayMatchmakingQueueNumber Parms{};
...
class UVALUI_CharacterCreationScreenBase* UWBP_PreGameHUD_CM_C::GetCharacterCreationScreen()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "GetCharacterCreationScreen");

	Params::WBP_PreGameHUD_CM_C_GetCharacterCreationScreen Parms{};
...
class UVALUI_LobbyScreenUserWidget* UWBP_PreGameHUD_CM_C::GetLobbyScreen()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "GetLobbyScreen");

	Params::WBP_PreGameHUD_CM_C_GetLobbyScreen Parms{};
...
void UWBP_PreGameHUD_CM_C::GotoCharacterLobby(const struct FVALDTOS_MetaCharacterFormat& CallFunc_GetCachedCharacterAtIndex_Checked_OutCharacter, TArray<struct FVALDTOS_MetaCharacterFormat>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "GotoCharacterLobby");

	Params::WBP_PreGameHUD_CM_C_GotoCharacterLobby Parms{};
...
void UWBP_PreGameHUD_CM_C::HandleOnCharacterCreationStateChanged(EVALUI_CharacterCreationState NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "HandleOnCharacterCreationStateChanged");

	Params::WBP_PreGameHUD_CM_C_HandleOnCharacterCreationStateChanged Parms{};
...
void UWBP_PreGameHUD_CM_C::HandleOnLobbyStateChanged(EVALUI_LobbyState NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "HandleOnLobbyStateChanged");

	Params::WBP_PreGameHUD_CM_C_HandleOnLobbyStateChanged Parms{};
...
void UWBP_PreGameHUD_CM_C::HandleOnLoginStateChanged(EVALUI_LoginState NewState)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "HandleOnLoginStateChanged");

	Params::WBP_PreGameHUD_CM_C_HandleOnLoginStateChanged Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWidget*                          CurrentLoginScreen                                     (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// TScriptInterface<class IBPI_LoginScreen_C>K2Node_DynamicCast_AsBPI_Login_Screen                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    K2Node_DynamicCast_bSuccess                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PreGameHUD_CM_C::HandleShowLoginScreen(class UWidget* CurrentLoginScreen, TScriptInterface<class IBPI_LoginScreen_C> K2Node_DynamicCast_AsBPI_Login_Screen, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "HandleShowLoginScreen");

	Params::WBP_PreGameHUD_CM_C_HandleShowLoginScreen Parms{};

	Parms.CurrentLoginScreen = CurrentLoginScreen;
	Parms.K2Node_DynamicCast_AsBPI_Login_Screen = K2Node_DynamicCast_AsBPI_Login_Screen;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
...
// Function WBP_PreGameHUD_CM.WBP_PreGameHUD_CM_C.OnInitialized
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UWBP_PreGameHUD_CM_C::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "OnInitialized");
...
void UWBP_PreGameHUD_CM_C::PlayFadeInAnimation(class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "PlayFadeInAnimation");

	Params::WBP_PreGameHUD_CM_C_PlayFadeInAnimation Parms{};
...
void UWBP_PreGameHUD_CM_C::SetOwner(class UVALUI_PregameUIManager* Owner)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PreGameHUD_CM_C", "SetOwner");

	Params::WBP_PreGameHUD_CM_C_SetOwner Parms{};
