...
void UAutomationUtilsBlueprintLibrary::TakeGameplayAutomationScreenshot(class FString& ScreenshotName, float MaxGlobalError, float MaxLocalError, const class FString& MapNameOverride)
{
